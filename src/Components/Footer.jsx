...
const Footer = () => {
    return (
        <div >
            <div className='px-[50px] py-[30px] md:px-[200px] md:py-[120px]  bg-[rgb(249,250,252)] '>
                ...
                <div className='card grid grid-cols-3 gap-5'>
                    <div className='border bg-white rounded-xl p-[10px] md:p-[40px] text-center border-none space-y-[20px]'>
            ...
            <div className='md:px-[120px] md:py-[200px] px-[30px] py-[50px]'>
                <div>
                    <div className='text-center'>
        ...
        <div className='bg-[#101727] md:pt-[120px] md:px-[200px] md:pb-[30px] px-[50px] pt-[30px] pb-[10px] text-white'>
           <div className='grid md:grid-cols-4 grid-cols-1 md:gap-[20px] gap-2'>
             <div>
